    ...
    <ScrollView flex={1}>
      <CircleCategories
        ...
        categories={[
          ...
          {
            name: 'Women',
            image: 'https://codervent.com/mobile/synrok/demo/assets/images/category/02.webp',
            navigate: {
              to: '',
              param: {},
            },
          ...
          {
            name: 'Kids',
            image: 'https://codervent.com/mobile/synrok/demo/assets/images/category/03.webp',
            navigate: {
              to: '',
              param: {},
            },
